...
import JobDetail from "./pages/job.jsx";
import EmployerDashboard from "./pages/employerdashboard_full.jsx";
import EditJob from "./pages/EditJob.jsx";
import MyApplications from "./pages/myapplication.jsx";
import ForEmployers from "./pages/ForEmployers.jsx";
import ForJobSeekers from "./pages/ForJobSeekers.jsx";
...
function Navigation() {
  ...
  const homeHref = loggedIn && role === "Admin" ? "/admin?tab=home" : "/";
          ...
          <div className="footer-container">
            <div className="footer-top">
              <div className="footer-section">
                <h3 className="footer-brand">SmartJob</h3>
                <p className="footer-description">
                  Your trusted platform for connecting talented professionals with amazing career opportunities.
                </p>
              ...
              <div className="footer-section">
                ...
                <ul className="footer-links">
                  <li><Link to="/login" state={{ targetRole: "Employer" }}>Post a Job</Link></li>
            ...
            <div className="footer-bottom">
              <p>&copy; 2025 SmartJob. All rights reserved.</p>
